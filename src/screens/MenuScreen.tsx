...
export const MenuScreen: FC<MenuScreenProps> = ({ stage, setScreenType }) => {
    ...
    const ART = {
        ...
        button: 'https://cdn.imgchest.com/files/a0ff4941978d.png',
            ...
            <div style={{ position: 'absolute', inset: 0, display: 'flex', alignItems: 'flex-end', justifyContent: 'center', zIndex: 1, overflow: 'hidden' }}>
                ...
                >
                    ...
                    <div style={{
                        ...
                        <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 'clamp(10px, 2.4vh, 22px)', marginTop: 'clamp(4px, 1.2vh, 12px)' }}>

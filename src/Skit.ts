    ...
    switch (skit.type) {
        case SkitType.BEGINNING:
            return !continuing ?
                ...
                `Open on a grounded, mundane moment in ${stage.getSave().player.name}'s day-to-day existence - establish their world, their routine, and their place in it (drawing on ${stage.getSave().player.name}'s profile). No supernatural events have ever touched this world, as far as anyone knows. ` +
